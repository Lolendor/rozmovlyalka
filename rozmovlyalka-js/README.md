...
Веб-порт украинского синтезатора речи **«Розмовлялька»** (2003) на JavaScript.
...
- 8-битный PCM 11025 Гц моно, как в движке 2003 года.
...
Дефолты демо: темп ×5, гучність **100%** (без зайвого посилення сигналу).
...
MIT. Порт оригинальной «Розмовляльки» («говорилка» 2003 года, авторская
